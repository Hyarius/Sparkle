...
TEST(OpenGLSamplerObjectTest, ConstructorWithParametersSetsNameTypeAndBindingPoint)
{
	...
	spk::OpenGL::SamplerObject sampler("uTexture", spk::OpenGL::SamplerObject::Type::Texture2D, 0);

	EXPECT_EQ(sampler.bindingPoint(), 0);
	EXPECT_EQ(sampler.type(), spk::OpenGL::SamplerObject::Type::Texture2D);
}
...
TEST(OpenGLSamplerObjectTest, SetTypeUpdatesValue)
{
	...
	spk::OpenGL::SamplerObject sampler;
	sampler.setType(spk::OpenGL::SamplerObject::Type::Texture1D);

	EXPECT_EQ(sampler.type(), spk::OpenGL::SamplerObject::Type::Texture1D);
}

TEST(OpenGLSamplerObjectTest, AllTypeEnumeratorsAreDistinct)
{
	EXPECT_NE(static_cast<GLenum>(spk::OpenGL::SamplerObject::Type::Texture1D),
	          static_cast<GLenum>(spk::OpenGL::SamplerObject::Type::Texture2D));
	EXPECT_NE(static_cast<GLenum>(spk::OpenGL::SamplerObject::Type::Texture2D),
	          static_cast<GLenum>(spk::OpenGL::SamplerObject::Type::Texture3D));
	EXPECT_NE(static_cast<GLenum>(spk::OpenGL::SamplerObject::Type::Texture3D),
	          static_cast<GLenum>(spk::OpenGL::SamplerObject::Type::TextureCubeMap));
}
...
TEST(OpenGLSamplerObjectTest, BindAssociatesWeakTexture)
{
	...
	auto tex = std::make_shared<spk::OpenGL::Texture>();
