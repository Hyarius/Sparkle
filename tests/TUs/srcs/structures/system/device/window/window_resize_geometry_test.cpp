...
namespace
{
	...
	public:
		...
		InsetLayoutWidget(const std::string& p_name, spk::Widget* p_parent, spk::Widget* p_content, const spk::Vector2Int& p_inset) :
...
TEST(WindowResizeGeometryTest, ResizedWindowUpdatesMainWidgetAndInsetChildGeometry)
{
	...
	InsetLayoutWidget mainWidget("Main", &sparkle_test::WindowAccess::rootWidget(*bundle.window), &contentWidget, spk::Vector2Int(50, 50));
