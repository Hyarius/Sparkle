...
TEST(ImageComparisonTest, MatchingImagesLeaveNoArtifacts)
{
	...
	const std::vector<unsigned char> pixels = {10, 20, 30, 255, 40, 50, 60, 255, 70, 80, 90, 255, 100, 110, 120, 255};
...
TEST(ImageComparisonTest, RgbDifferenceAtToleranceMatchesAndAboveToleranceDiffers)
{
	...
	const std::vector<unsigned char> actualPixels = {104, 100, 100, 255, 105, 100, 100, 255};
	const std::vector<unsigned char> expectedPixels = {100, 100, 100, 255, 100, 100, 100, 255};
...
TEST(ImageComparisonTest, DimensionMismatchMarksOutOfOverlapPixels)
{
	...
	const std::vector<unsigned char> actualPixels = {10, 20, 30, 255, 40, 50, 60, 255, 70, 80, 90, 255, 100, 110, 120, 255};
	const std::vector<unsigned char> expectedPixels = {10, 20, 30, 255, 40, 50, 60, 255};
...
TEST(ImageComparisonTest, AllPixelsDifferentAreCounted)
{
	...
	const std::vector<unsigned char> actualPixels = {255, 0, 0, 255, 0, 255, 0, 255, 0, 0, 255, 255, 255, 255, 255, 255};
	const std::vector<unsigned char> expectedPixels = {0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255};
...
TEST(ImageComparisonTest, DifferentPixelsAreMarkedInRed)
{
	...
	const std::vector<unsigned char> actualPixels = {0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0, 255, 0, 0, 0, 255};
	const std::vector<unsigned char> expectedPixels = {0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255};
