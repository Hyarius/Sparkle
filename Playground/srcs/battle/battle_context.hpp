...
namespace pg
{
	...
	public:
		...
		// ---- Queries -----------------------------------------------------------------------------
		[[nodiscard]] const BattleDescriptor &descriptor() const noexcept { return _descriptor; }
		[[nodiscard]] BattleId battleId() const noexcept { return _descriptor.battleId; }
		[[nodiscard]] const Registries &registries() const noexcept { return *_registries; }
		[[nodiscard]] const BoardData &board() const noexcept { return _board; }
		...
		[[nodiscard]] const std::vector<BattleUnitId> &enemyOrder() const noexcept { return _enemyOrder; }
		...
		[[nodiscard]] std::size_t rngDrawCount() const noexcept { return _rng.drawCount(); }
		[[nodiscard]] const BattleEventLog &events() const noexcept { return _events; }
		[[nodiscard]] const std::vector<CommittedBattleBatch> &archivedBatches() const noexcept { return _archive; }
		...
		void removeUnit(BattleUnitId p_unit, RemovalReason p_reason, const BattleEventOrigin &p_origin,
