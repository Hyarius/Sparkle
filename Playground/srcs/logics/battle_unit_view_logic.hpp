...
namespace pg
{
	...
	private:
		...
		const Registry<ModelDefinition> *_models = nullptr;
		ModelDefinition _fallbackModel;
	...
	public:
		...
		explicit BattleUnitViewLogic(
			spk::GameEngine &p_engine,
			const spk::Texture *p_texture = nullptr,
			const Registry<ModelDefinition> *p_models = nullptr);
		...
		[[nodiscard]] std::size_t partCount(const BattleUnit &p_unit) const noexcept;
