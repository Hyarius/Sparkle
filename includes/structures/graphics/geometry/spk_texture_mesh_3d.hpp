...
namespace spk
{
	struct TextureVertex3D
	{
		...
		[[nodiscard]] bool operator==(const TextureVertex3D &p_other) const noexcept
		{
...
{
	template <>
	struct hash<spk::TextureVertex3D>
	{
		std::size_t operator()(const spk::TextureVertex3D &p_value) const noexcept
		{
...
namespace spk
{
	using TextureMesh3DLayout = spk::MeshLayout<
	...
	using TextureMesh3D = spk::GenericMesh<spk::TextureVertex3D, spk::TextureMesh3DLayout>;
}
