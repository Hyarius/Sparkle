...
namespace spk
{
	...
	protected:
		...
		virtual GLenum _expectedType() const noexcept = 0;
	...
	private:
		void _synchronize() const final override
		{
			...
			{
				_location = spk::OpenGL::Uniform::findLocation(programId, _name);
	...
	protected:
		GLenum _expectedType() const noexcept override
		{
			return TSpecification::OpenGLType;
		}
